...
public class Tile extends JPanel{
	...
	private Color player1 = color_lib[r.nextInt(color_lib.length)];
	private Color player2 = color_lib[r.nextInt(color_lib.length)];
	...
	public void init() {
		...
		// to make sure the tile is differenct
		while(player1 == player2) {
			System.out.println("SAMA");
			player2 = color_lib[r.nextInt(color_lib.length)];
		}
